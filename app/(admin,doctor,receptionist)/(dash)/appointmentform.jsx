...
const appointmentform = () => {
    const formFields = [
        ...
        { name: 'dob', label: 'Date Of Birth', type: 'date', defaultValue: '2025-04-01 17:33:57' },
    ...
    return <MyForm formFields={formFields} onSubmit={handleSubmit} isSubmitting={false} />;
};
